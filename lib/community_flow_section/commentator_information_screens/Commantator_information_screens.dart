...
import 'package:moon_sports/community_flow_section/commentator_information_screens/Commantator_information_MatchesScreen.dart';
import 'package:moon_sports/community_flow_section/commentator_information_screens/Commentator_information_info_screen.dart';
...
class CommantatorInformationScreens extends StatefulWidget {
  const CommantatorInformationScreens({super.key});

  @override
  State<CommantatorInformationScreens> createState() => _CommantatorInformationScreensState();
}

class _CommantatorInformationScreensState extends State<CommantatorInformationScreens>with TickerProviderStateMixin {
  @override
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    "Commantator Profile ".text.white.bold.size(15).make(),
            ...
            Expanded(
              child:TabBarView(
                ...
                children: [
                  ...
                  RefreshIndicator(
                      child: CommentatorInformationInfoScreen(),
                      onRefresh: ()async{}),


                  RefreshIndicator(
                      child: CommantatorInformationMatchesscreen(),
                      onRefresh: ()async{}),
